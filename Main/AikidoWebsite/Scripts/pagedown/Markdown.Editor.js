...
(function () {
    ...
    markdownConv.Editor = function (markdownConverter, idPostfix, options) {
        ...
        var hooks = this.hooks = new markdownConv.HookCollection();
    ...
    function UIManager(postfix, panels, undoManager, previewManager, commandManager, helpOptions, getString) {
        ...
        function makeSpritedButtonRow() {
            ...
            buttons.quote = makeButton("wmd-quote-button", getString("quote"), "icon-quote-left", bindCommand("doBlockquote"), group);
            ...
            var group = makeGroup();            
            buttons.olist = makeButton("wmd-olist-button", getString("olist"), "icon-list-ol", bindCommand(function (chunk, postProcessing) {
                this.doList(chunk, postProcessing, true);
            }), group);
            buttons.ulist = makeButton("wmd-ulist-button", getString("ulist"), "icon-list-ul", bindCommand(function (chunk, postProcessing) {
                this.doList(chunk, postProcessing, false);
            }), group);
            buttons.heading = makeButton("wmd-heading-button", getString("heading"), "icon-reorder", bindCommand("doHeading"), group);
            buttons.hr = makeButton("wmd-hr-button", getString("hr"), "icon-minus", bindCommand("doHorizontalRule"), group);
